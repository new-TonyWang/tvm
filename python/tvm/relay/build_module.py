...
class BuildModule(object):
    ...
    def __init__(self):
        ...
        self._get_graph_json = self.mod["get_graph_json"]#根据字符串找到TVMRuntime中对应的方法通过GetFunction找到rt中的PackedFunc，并返回为Python的packedFunc类型
    ...
    def optimize(self, mod, target=None, params=None):
        ...
        if params:
            self._set_params(params)
        mod = self._optimize(mod, target)#GetFunction
        # Get artifacts
        params = self.get_params()
